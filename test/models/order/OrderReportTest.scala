...
class OrderReportTest extends Specification {
  ...
  "OrderReport" should {
    ...
    "should be writeable into xml" in {
      ...
      val items1 = ProductReport("1011-22432", "https://raw.githubusercontent.com/tsechov/shoehorn/68ea2560e9bcc703703565bf728e5a3a93ececd5/test/resources/1195-21709-thumb.jpg", sortiment1)
      val sortiment2 = List(SortimentItem(19, 2), SortimentItem(24, 1), SortimentItem(34, 5))
      val items2 = ProductReport("1127-22182", "https://raw.githubusercontent.com/tsechov/shoehorn/68ea2560e9bcc703703565bf728e5a3a93ececd5/test/resources/1222-43633-thumb.jpg", sortiment2)
